...
function cr:system/string/_append {"text": ',{"text": "[实体数量] ", "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set %MAX_ENTITY_COUNT% const "}, "hoverEvent": {"action": "show_text", "contents": {"text": "每个地皮中最多同时存在的实体数量。最小为 0 ，最大为 256 。"}}}'}
function cr:system/string/send_all
